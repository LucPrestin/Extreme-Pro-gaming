...
\begin{tikzpicture}[remember picture, overlay]
    \cardborder{north west}{$(current page.north west) + (0mm, -60mm) + (0mm, 0mm)$}{pastevents}{Past\\Events}
    ...
    \cardborder{north west}{$(current page.north west) + (0mm, -60mm) + (600mm, -340mm)$}{completedfeatures}{Completed\\Features}
    \cardborder{north west}{$(current page.north west) + (0mm, -60mm) + (720mm, -340mm)$}{fixedbugs}{Fixed\\Bugs}
    ...
    \node[anchor=north west, text centered, font=\huge, text width = 140mm] at (storypointsbox.north west) {Permanent quota};
    \node[anchor=north east, text centered, font=\huge, text width = 70mm] at (storypointsbox.north east) {Temporarily not usable};
