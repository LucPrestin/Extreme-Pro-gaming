...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw[->, line width = 1mm, dotted] ($(title.north west) + (0mm, -2.5mm)$) -- ($(title.north west) + (-20mm, -2.5mm)$);
        ...
        \draw[->, line width = 1mm, dotted] ($(foreshadowing.north west) + (0mm, -2.5mm)$) -- ($(foreshadowing.north west) + (-20mm, -2.5mm)$);
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
    \begin{tikzpicture}
        ...
        \draw[->, line width = 1mm, dotted] ($(startmarker.west) + (0mm, -1mm)$) -- ($(startmarker.west) + (-18mm, -1mm)$);
        ...
        \node[anchor = south west, text width = 50mm] (title) at ($(bug.south east) + (10mm, 4mm)$) {\textbf{Title}: A description of the ticket.};
        \draw[->, line width = 1mm, dotted] ($(title.north west) + (0mm, -2.5mm)$) -- ($(title.north west) + (-14mm, -2.5mm)$);
